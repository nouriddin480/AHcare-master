  ...
  <div className={utilStyles.imageRow2}>
    <div className={utilStyles.imageColumn2}>
      <div className={utilStyles.imageWrapper2}>
        ...
        <p className={utilStyles.S1}>Dive into the role of AI in e-medicine, including AI-powered diagnostics, medical chatbots, and predictive analytics. Discover how AI enhances healthcare through accurate diagnoses, virtual assistance, and early disease detection.</p>
      </div>
    </div>
    <div className={utilStyles.imageColumn2}>
      <div className={utilStyles.imageWrapper2}>
